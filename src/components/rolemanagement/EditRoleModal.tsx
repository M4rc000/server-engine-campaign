...
import EditRoleModalForm, {EditRoleModalFormRef} from './EditRoleModalForm'
...
export default function EditRoleModal({
  ...
  const formRef = useRef<EditRoleModalFormRef>(null);
          ...
          >
            ...
            >
              ...
              <div className="px-6 py-4 overflow-y-auto flex-1">
                <EditRoleModalForm ref={formRef} role={role!}/>
              </div>
