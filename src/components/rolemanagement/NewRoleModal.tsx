...
import NewRoleModalForm, { NewRoleModalFormRef } from './NewRoleModalForm'
...
export default function NewRoleModal({
  ...
  const formRef = useRef<NewRoleModalFormRef>(null);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const success = await formRef.current.submitRoles();
      
      if (success) {
        onRoleAdded(); // ⬅️ panggil reload
        onClose();
      }
    } catch (error) {
          ...
          >
            ...
            >
              ...
              <div className="px-6 py-4 overflow-y-auto flex-1">
                <NewRoleModalForm ref={formRef} onSuccess={onRoleAdded} />
              </div>
