...
import ShowLandingPageDetailModalForm from './ShowLandingPageDetailModalForm'
...
export default function ShowLandingPageDetailModal({
  isOpen,
  onClose,
  landingPage,
}: ShowLandingPageDetailModalProps) {
  return (
          ...
          >
            <DialogPanel className="w-full xl:max-w-fit box-border rounded-lg bg-white dark:bg-gray-900 shadow-xl overflow-hidden dark:border dark:border-gray-700 flex flex-col max-h-[90vh] xl:mt-5 z-[9999999999999]">
              ...
              <div className="px-6 py-4 overflow-y-auto flex-1">
                <ShowLandingPageDetailModalForm landingPage={landingPage!}/>
              </div>
