...
import NewLandingPageModalForm, { NewLandingPageModalFormRef } from './NewLandingPageModalForm'

export type NewLandingPageModalProps = {
  isOpen: boolean
  onClose: () => void
...
export default function NewLandingPageModal({
  ...
  const formRef = useRef<NewLandingPageModalFormRef>(null);
