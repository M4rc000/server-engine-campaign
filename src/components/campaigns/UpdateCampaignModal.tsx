...
import UpdateCampaignModalForm, { UpdateCampaignModalFormRef } from './UpdateCampaignModalForm'
...
export default function UpdateCampaignModal({
  ...
  const formRef = useRef<UpdateCampaignModalFormRef>(null);
          ...
          >
            ...
            <DialogPanel className="w-full xl:max-w-5xl box-border rounded-lg bg-white dark:bg-gray-900 shadow-xl overflow-visible dark:border dark:border-gray-700 flex flex-col max-h-[90vh] xl:mt-5 z-[9999999999999]">
              ...
              <div className="px-6 py-4 overflow-y-auto flex-1">
                {/* Pastikan campaign tidak null sebelum diteruskan ke UpdateCampaignModalForm */}
                {campaign && (
                  <UpdateCampaignModalForm ref={formRef} campaign={campaign} onUpdateSuccess={onUpdateSuccess} />
                )}
              </div>
