...
import NewGroupModalForm, { NewGroupModalFormRef } from './NewGroupModalForm'
...
export default function NewGroupModal({
  ...
  const formRef = useRef<NewGroupModalFormRef>(null);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Calls the submitGroups method exposed by the child form
      const success = await formRef.current.submitGroups();
      ...
      if (success) {
        ...
        onGroupAdded(); // Callback to parent to signal group added (e.g., refresh list)
          ...
          >
            ...
            >
              ...
              <div className="px-6 py-4 overflow-y-auto flex-1">
                <NewGroupModalForm ref={formRef} onSuccess={onGroupAdded} />
              </div>
