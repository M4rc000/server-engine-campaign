...
const AppSidebar: React.FC = () => {
  ...
  return (
    <aside
      className={`fixed mt-16 flex flex-col lg:mt-0 top-0 px-5 left-0 bg-gray-900 dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-50 border-r border-gray-200 
        ${
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            {navGroups.map((group) => (
              <div key={group.title}>
                <h2
                  className={`mb-4 text-xs uppercase flex leading-[20px] text-gray-500 font-semibold dark:text-gray-500 ${
