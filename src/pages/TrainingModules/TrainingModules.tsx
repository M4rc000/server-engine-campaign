    ...
    return (
      <div key={card.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 px-4 py-3 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
          ...
          <span className="text-xs text-gray-500 bg-gray-200 dark:bg-gray-700 dark:text-gray-400 px-2 py-1 rounded">{card.type}</span>
        </div>

        {/* Content */}
        <div className="">
          <img className='w-full h-60' src={`/images/training-modules/${card.image}`} alt={card.title} />
        </div>
        
        {/* Action Buttons */}
        <div className="bg-gray-50 dark:bg-gray-900 px-1 py-3 gap-4 border-t border-gray-200 dark:border-gray-700 flex justify-center">
          <button 
