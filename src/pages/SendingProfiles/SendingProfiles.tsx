...
export default function SendingProfiles() {
  ...
  return (
    <>
      <div className="grid grid-cols-12 gap-4 md:gap-6 mt-10 mb-1 px-4">
        <div className="col-span-12 space-y-6 xl:col-span-7">
          <CardHeader reloadTrigger={reloadTrigger}/>
        </div>
      </div>
      <Button className="text-md mt-5 mb-3 mx-4" onClick={()=> setNewModalOpen(true)}>New Sending Profile</Button>
